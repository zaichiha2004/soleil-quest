...
{screen==="ikigai"&&(
  ...
  <div style={{position:"absolute",top:60,left:0,width:360,height:360}}>
            ...
            {[
              ...
              <div key={i} style={{position:"absolute",fontSize:12,color:"#ffffff",fontWeight:500,lineHeight:1.4,pointerEvents:"none",whiteSpace:"pre-line",textShadow:"0 1px 4px rgba(0,0,0,1)",...l.style}}>{l.label}</div>
            ))}
          </div>
      </div>

...
{screen==="ikigai"&&(
      ...
      return (
        <div>
          <div style={{position:"relative",width:360,height:440,margin:"0 auto 12px"}}>
            {/* Callouts */}
  <div style={{position:"absolute",top:8,left:0,fontSize:10,color:"rgba(250,250,250,.18)",lineHeight:1.45,fontStyle:"italic",maxWidth:75,zIndex:30}}>Satisfaction,<br/>but feeling of<br/>uselessness</div>
  <div style={{position:"absolute",top:8,right:0,fontSize:10,color:"rgba(250,250,250,.18)",lineHeight:1.45,fontStyle:"italic",maxWidth:75,textAlign:"right",zIndex:30}}>Delight and<br/>fullness, but<br/>no wealth</div>
  ...
  <svg style={{position:"absolute",inset:0,width:"100%",height:"100%",pointerEvents:"none",zIndex:20}} viewBox="0 0 360 440">
    {(()=>{
      ...
      return(<>
        <path d={wp(40,42,129,240)} stroke="rgba(255,255,255,.35)" strokeWidth="1.2" fill="none" strokeDasharray="3,3"/>
        <circle cx="129" cy="240" r="2.5" fill="rgba(255,255,255,.5)"/>

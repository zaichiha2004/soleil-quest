...
export default function App() {
  ...
  <button key={k} className={`ntab ${tab===k?"on":"off"}`} style={k==="home"?{border:"0.5px solid rgba(212,163,89,.4)",color:tab==="home"?"#d4a359":"rgba(212,163,89,.7)",fontWeight:700,fontSize:12,letterSpacing:"0.05em"}:{}} onClick={()=>{setTab(k);goTo(k==="home"?"checkin":k==="talk"?"talk":k);}}>{label}</button>
            ))}
          </div>
